"""
Django settings for movie_chatbot_learn_46557 project.
...
ROOT_URLCONF = 'movie_chatbot_learn_46557.urls'
...
WSGI_APPLICATION = 'movie_chatbot_learn_46557.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "movie_chatbot_learn_46557 API",
    "DESCRIPTION": "API documentation for movie_chatbot_learn_46557 App",
    "VERSION": "v1",
}
